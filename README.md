...
If making changes to the frontend (HTML or JS), make sure to run the below so the CSS file is updated.
```shell
npm run watch:css
```
...
## Documentation
See the [wiki](https://github.com/USEPA/emanifest-data-upload/wiki)
